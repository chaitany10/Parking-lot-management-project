...
urlpatterns = [
    ...
    path('parking_lot/block/floor/<int:block_no>',views.floor_index,name='floor_index'),
    path('parking_lot/block/floor/parking_slot/<int:floor_no>',views.parking_slot_index,name='parking_slot_index'),
